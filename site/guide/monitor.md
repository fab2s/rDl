...
prev_url: /guide/utilities
prev_title: "Utilities"
---
...
> **Prerequisites**: [Training](/guide/training) covers the training loop.
> [Utilities](/guide/utilities) covers observation and trends.
...
See the `flodl/examples/quickstart/` directory in the repository for
